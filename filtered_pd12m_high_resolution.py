...
parquet_dir = '/data/tzz/4k_data_curation/datasets/PD12M/orginal_dataset/metadata'  # Update this to the correct relative path to your parquet files
output_csv_dir = '/data/tzz/4k_data_curation/datasets/PD12M'  # Update this to the correct relative path for output
