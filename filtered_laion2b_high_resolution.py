...
parquet_dir = '/data/tzz/4k_data_curation/datasets/laion2b/laion2B-en-aesthetic'  # Update this if needed

# Define output directory for filtered parquet files
output_parquet_dir = '/data/tzz/4k_data_curation/datasets/laion2b/filtered'  # Update as needed
