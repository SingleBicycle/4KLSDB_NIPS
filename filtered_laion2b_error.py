...
parquet_dir = '/data/tzz/4k_data_curation/qwen2-vl/laion2b/labeled'  # Update this if needed

# Define output directory for filtered parquet files
output_parquet_dir = '/data/tzz/4k_data_curation/qwen2-vl/laion2b/labeled_without_error'  # Update as needed
