...
csv_file = '/data/tzz/4k_data_curation/qwen2-vl/PCB_final_without_unknown.csv'  # Update with the actual path to your input file

# Directory for the filtered CSV file
output_csv_dir = '/data/tzz/4k_data_curation/qwen2-vl/'  # Update as needed
