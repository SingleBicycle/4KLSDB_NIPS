...
CHECKPOINT_FILE = "checkpoint_filtered_images_third_trail.csv"
PROGRESS_FILE = "progress_checkpoint_third_trail.txt"
CSV_INPUT_FILE = "/data/tzz/4k_data_curation/milestone_1_summary/filtered_images.csv"  # your input CSV file
